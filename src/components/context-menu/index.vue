<script lang="tsx">
import { defineComponent, nextTick, onMounted, reactive, computed, ref, unref, onUnmounted } from 'vue'
    ...
    return () => {
      ...
      return (
        <div ref={wrapRef} class="content-menu">
          <Menu v-model_selectedKeys={selectedKeys} inlineIndent={12} mode="vertical" v-show={state.show} style={unref(getStyle)}>
